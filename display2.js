...
lib.ssMetadata = [
		{name:"无标题_1_atlas2_", frames: [[0,1802,1764,1146],[0,0,1748,1800],[1750,0,1748,1800]]}
];
...
(lib.b37e7642492384b810b3b711e22b2ce = function() {
	this.spriteSheet = ss["无标题_1_atlas2_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/无标题_1_atlas2_.png", id:"无标题_1_atlas2_"}
	],
	preloads: []
};
