...
lib.ssMetadata = [
		{name:"无标题_3_atlas_3", frames: [[0,1802,1920,1080],[0,0,1748,1800],[1750,0,1748,1800]]}
];
...
(lib.Bitmap1 = function() {
	this.spriteSheet = ss["无标题_3_atlas_3"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/无标题_3_atlas_3.png", id:"无标题_3_atlas_3"}
	],
	preloads: []
};
