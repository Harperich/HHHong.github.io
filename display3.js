...
lib.ssMetadata = [
		{name:"无标题_3_atlas33_", frames: [[0,0,1920,1080],[0,1082,400,300],[402,1082,400,300]]}
];
...
(lib.Bitmap1 = function() {
	this.spriteSheet = ss["无标题_3_atlas33_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/无标题_3_atlas33_.png", id:"无标题_3_atlas33_"}
	],
	preloads: []
};
